...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    ...
    <a class="btn btn-outline--primary h-45" href="<?php echo e(route('admin.withdraw.method.create')); ?>"><i
            class="la la-plus"></i><?php echo app('translator')->get('Add New'); ?></a>
    </div>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/lotter/core/resources/views/admin/withdraw/index.blade.php ENDPATH**/ ?>